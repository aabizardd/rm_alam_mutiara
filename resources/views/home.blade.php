                                ...
                                <div class="card h-100">
                                    ...
                                    <div class="card-body">
                                        <div class="row align-items-end">
                                            <div class="col-6">
                                                <h1 class="display-6 text-primary mb-2 pt-4 pb-1">
                                                    $89k
                                                </h1>
                                                <small class="d-block mb-3">You have done 57.6%
                                                    <br />more sales
                                                    today.</small>
                                            ...
                                            <div class="col-6">
                                                <img src="../../assets/img/illustrations/prize-light.png" width="140"
                                                    ...
                                                    data-app-dark-img="illustrations/prize-dark.html" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                <ul class="list-unstyled m-0 pt-0">
                                                    <li class="mb-4">
                                                        <div class="d-flex align-items-center mb-2">
                                                            ...
                                                            <div>
                                                                <p class="mb-0 lh-1 text-muted text-nowrap">
                                                                    Earnings
                                                                    This
                                                                    Month
                                                                </p>
                                            ...
                                            <li class="d-flex mb-4">
                                                ...
                                                <div
                                                    ...
                                                    <div class="me-2">
                                                        ...
                                                        <small class="text-muted">39k New
                                                            Sales</small>
                                                    </div>
                                                    <div class="item-progress">
                                                        26M
                                            ...
                                            <li class="d-flex mb-4">
                                                ...
                                                <div
                                                    ...
                                                    <div class="me-2">
                                                        ...
                                                        <small class="text-muted">43k New
                                                            Revenue</small>
                                                    </div>
                                                    <div class="item-progress">
                                                        15M
                                        ...
                                        <table class="table border-top">
                                            ...
                                            <tbody class="table-border-bottom-0">
                                                <tr>
                                                    <td class="text-nowrap">
                                                        <img src="../../assets/img/icons/brands/fastrack.png"
                                                            class="me-3" width="22" alt="Fastrack" />Fastrack
                                                        Watches
                                                    </td>
                                                    <td class="text-nowrap">
                                                        <i class="bx bx-trending-up text-success me-2"></i>28.5%
                                                    </td>
                                                    <td>$1,324</td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-end"
                                                                ...
                                                                <a class="dropdown-item" href="javascript:void(0);">Write
                                                                    a
                                                                    Review</a>
                                                                <a class="dropdown-item"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <i class="bx bx-trending-down text-danger me-2"></i>56.6%
                                                    </td>
                                                    <td>$3,573</td>
                                                    <td>
                                                        <span class="text-success">Active</span>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <i class="bx bx-trending-up text-success me-2"></i>23.8%
                                                    </td>
                                                    <td>$12,347</td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="../../assets/img/icons/brands/oneplus.png"
                                                            class="me-3" width="22" alt="OnePlus" />Oneplus 7
                                                        Pro
                                                    </td>
                                                    <td>
                                                        <i class="bx bx-trending-up text-success me-2"></i>81.4%
                                                    </td>
                                                    <td>$5,347</td>
                                                    <td>
                                                        <span class="text-success">Active</span>
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="../../assets/img/icons/brands/google.png" class="me-3"
                                                            width="22" alt="Google" />Google
                                                        Pixal 6
                                                    </td>
                                                    <td>
                                                        <i class="bx bx-trending-down text-danger me-2"></i>12.8%
                                                    </td>
                                                    <td>$45,678</td>
                                                    <td>
                                                        <span class="text-danger">Closed</span>
