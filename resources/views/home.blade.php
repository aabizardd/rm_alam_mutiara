                                    ...
                                    <div class="col-6 col-md-3 col-lg-3 mb-4">
                                        <div class="card h-100">
                                            <div class="card-body text-center">
                                                <div class="avatar mx-auto mb-2">
                                                    <span class="avatar-initial rounded-circle bg-label-success"><i
                                                            class="tf-icons bx bx-store-alt fs-4"></i></span>
                                                </div>
                                                <span class="d-block text-nowrap">Toko Pembelian</span>
                                                <h2 class="mb-0">{{ $toko }}</h2>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-6 col-md-3 col-lg-3 mb-4">
                                        <div class="card h-100">
                                            <div class="card-body text-center">
                                                <div class="avatar mx-auto mb-2">
                                                    <span class="avatar-initial rounded-circle bg-label-success"><i
                                                            class="tf-icons bx bx-food-menu fs-4"></i></span>
                                                </div>
                                                <span class="d-block text-nowrap">Jumlah Menu Tersedia</span>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body overflow-auto" style="max-height: 300px;">
                                        <ul class="p-0 m-0">
                                            ...
                                            @foreach ($makanan_hariini as $item)
                                                <li class="d-flex mb-4">
                                                    <div class="avatar avatar-sm flex-shrink-0 me-3">
                                                        <span class="avatar-initial rounded-circle bg-label-primary">
                                                            <img src="{{ asset('assets/img/menu/' . $item->gambar) }}"
                                                                alt="" style="border-radius: 100%">
                                                        </span>
                                                    </div>
                                                    <div
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body overflow-auto" style="max-height: 300px;">
                                        <ul class="p-0 m-0">
                                            ...
                                            @foreach ($minuman_hariini as $item)
                                                <li class="d-flex mb-4">
                                                    <div class="avatar avatar-sm flex-shrink-0 me-3">
                                                        <span class="avatar-initial rounded-circle bg-label-primary">
                                                            <img src="{{ asset('assets/img/menu/' . $item->gambar) }}"
